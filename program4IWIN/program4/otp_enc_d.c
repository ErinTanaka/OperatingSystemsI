...
int main(int argc, char *argv[])
{
	...
	char * buffer=calloc(150000,sizeof(char)); //allocating enough space to accomodate largest plaintextfile and key
		...
		switch (spawnPid){
			...
			case 0:{ //child process, encrypt message here
			  	...
			  	if(strstr(buffer, "@@")==NULL){
			     		fprintf(stderr, "ERROR: Not communicating with otp_enc\0");
			     		return 3;
			     		exit (3);
			  	}
